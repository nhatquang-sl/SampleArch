...
namespace SampleArch.Controllers
{
    public class PersonController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Id,Name,Phone,Address,State,CountryId,CreatedDate,CreateBy,UpdatedDate,UpdatedBy")] Person person)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,Name,Phone,Address,State,CountryId,CreatedDate,CreateBy,UpdatedDate,UpdatedBy")] Person person)
        {
            if (ModelState.IsValid)
            {
